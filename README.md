...
**[Fast installs](https://aube.en.dev/benchmarks).** Warm CI is about 6x faster than pnpm and 2x faster than Bun in the current benchmarks. Repeat test commands run up to ~45x faster than pnpm and up to 3x faster than Bun.
