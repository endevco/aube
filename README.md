...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.en.dev/benchmarks).** Warm installs are about 3x faster than pnpm and about 2x faster than Bun in the current benchmarks. Repeat test commands run up to 28x faster than pnpm and up to 4x faster than Bun.
<!-- BENCH_RATIOS:END -->
