...
**[Fast installs](https://aube.en.dev/benchmarks).** Warm CI is about 10x faster than pnpm and 5x faster than Bun in the current benchmarks. Across the fixture set, aube runs up to ~52x faster than pnpm and up to 5x faster than Bun.
