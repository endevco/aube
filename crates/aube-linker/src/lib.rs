...
pub(crate) use patches::{
    apply_multi_file_patch, current_patch_hashes, read_applied_patches,
    wipe_changed_patched_entries, write_applied_patches,
};
pub use pool::default_linker_parallelism;
pub(crate) use pool::with_link_pool;
pub(crate) use sweep::{
    EntryState, classify_entry_state, remove_hidden_hoist_tree, sweep_dead_hidden_hoist_entries,
