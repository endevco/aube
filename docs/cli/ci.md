---
description: "Clean install: delete node_modules, then install with frozen lockfile."
editLink: false
---
...
Read the [workflow guide](/package-manager/ci) for context.
...
- **`--ignore-scripts`** — Skip root and dependency lifecycle scripts
