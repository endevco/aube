...
| npm | `package-lock.json`, `npm-shrinkwrap.json` | [For npm users](/npm-users) |
| Yarn classic | `yarn.lock` v1 | [For yarn users](/yarn-users) |
| Yarn berry | `yarn.lock` v2+ | [For yarn users](/yarn-users) |
